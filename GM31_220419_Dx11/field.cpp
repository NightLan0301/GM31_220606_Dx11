...
void Field::Init()
{
	...
	vertex[0].Position = D3DXVECTOR3(-10.0f, 0.0f, 10.0f);		//coordinate
	vertex[0].Normal   = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	vertex[0].Diffuse  = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);	//rgb, transparent
	vertex[0].TexCoord = D3DXVECTOR2(0.0f, 0.0f);				//texure hw
